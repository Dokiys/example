...
func handleSendNotification(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	svc := server.ServerFromContext(ctx)

	err := svc.SendNotificationToClient(
		ctx,
